...
export default function Hero() {
  return (
    <>
      <section className='-mt-8 hidden max-lg:block'>
        <div className='pt-8'>
          <Navbar />
        </div>
      </section>
      <div className='hero-section min-h-[600px] h-screen overflow-hidden relative'>
        ...
        <div className='flex flex-col justify-center items-center'>
          <Grid className='z-[5]'>
            <Cell
              cols='1_full'
              rows='1_1'
              className='flex flex-col mt-6 sm:mt-4'
            >
              <Typography
                as='h1'
                variant='h5'
          ...
          <div className='bg-primary-50 mx-auto w-[90%] rounded-md lg:w-[82%] h-[400px] lg:h-[40vh] flex justify-center items-center overflow-hidden z-[3] mt-9 lg:mt-[5vh] drop-shadow-2xl lg:rounded-2xl'>
