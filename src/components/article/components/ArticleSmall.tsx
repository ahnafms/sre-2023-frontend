...
export default function ArticleSmall({ data }: ArticleSmallProps) {
  ...
  return (
    <UnstyledLink href={path + '/' + data.id}>
      <div className='p-4 bg-white w-min rounded-[20px] hover:bg-slate-100 hover:cursor-pointer'>
        <div className='w-[234px] lg:w-[367px] h-[191px] lg:h-[300px] rounded-[20px] overflow-hidden relative'>
          <Image
